...
%{ endif ~}
    ...
    write_files:
      ...
      # Elasticsearch bootstrap requirement (vm.max_map_count)
      - path: /etc/sysctl.d/90-elasticsearch.conf
        content: |
          vm.max_map_count=${vm_max_map_count}

      # Raise memlock + nofile limits for the container runtime
      - path: /etc/security/limits.d/90-elasticsearch.conf
        content: |
